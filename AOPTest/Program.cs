...
namespace AOPTest
{
    class Program
    {
        ...
        private static void CreateContainer()
        {
            ...
            builder.RegisterType<InvoiceRepository>().As<IInvoiceRepository>().InstancePerLifetimeScope().EnableInterfaceInterceptors().InterceptedBy(typeof(LoggingInterceptor));
            builder.RegisterType<ItemRepository>().As<IItemRepository>().InstancePerLifetimeScope().EnableInterfaceInterceptors().InterceptedBy(typeof(LoggingInterceptor));
            builder.RegisterType<UnitOfWork>().As<IUnitOfWork>().InstancePerLifetimeScope().OwnedByLifetimeScope().EnableInterfaceInterceptors().InterceptedBy(typeof(LoggingInterceptor));
            builder.RegisterType<OrderCreatorService>().As<IOrderCreatorService>().SingleInstance().EnableInterfaceInterceptors().InterceptedBy(typeof(LoggingInterceptor));
            builder.RegisterType<InvoiceCreatorService>().As<IInvoiceCreatorService>().SingleInstance().EnableInterfaceInterceptors().InterceptedBy(typeof(LoggingInterceptor));
